...
namespace PENet
{
    public class PETool
    {
        ...
        public static byte[] PackNetMsg<T>(T msg) where T : PEMessage
        {
        ...
        public static byte[] Serialize<T>(T pkg) where T : PEMessage
        {
        ...
        public static T DeSerialize<T>(byte[] bs) where T : PEMessage
        {
